...
_CONNECT_KWARGS = set(inspect.signature(websockets.sync.client.connect).parameters)
    ...
    def _wait_for_server(self, timeout: float = 300) -> Tuple[websockets.sync.client.ClientConnection, Dict]:
        ...
        while True:
            ...
            try:
                ...
                # websockets <14 sync client doesn't accept ping_*; drop unsupported kwargs.
                connect_kwargs = {k: v for k, v in connect_kwargs.items() if k in _CONNECT_KWARGS}
